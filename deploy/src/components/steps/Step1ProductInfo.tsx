  ...
  return (
    ...
    >
                ...
                ([key, cat]) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`flex flex-col items-center justify-center gap-1.5 py-3 px-2 rounded-lg transition-all duration-300 ${
                        isSelected
                    ...
                    >
                      <span className={`text-xl ${isSelected ? '' : 'opacity-70'}`}>{cat.icon}</span>
      ...
      <div className="mt-8 bg-[#c3c0ff]/5 border border-[#c3c0ff]/10 rounded-xl p-5 flex gap-4">
        <span className="text-[#c3c0ff] text-xl">💡</span>
