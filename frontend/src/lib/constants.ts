...
export const CATEGORIES: Record<CategoryKey, CategoryInfo> = {
  ...
  pets: { label: '반려동물', primary: '#FF7043', secondary: '#FBE9E7', icon: '🐾' },
  kids: { label: '유아/아동', primary: '#F06292', secondary: '#FCE4EC', icon: '👶' },
  sports: { label: '스포츠/아웃도어', primary: '#00ACC1', secondary: '#E0F7FA', icon: '⛹️' },
  interior: { label: '인테리어/가구', primary: '#5D4037', secondary: '#EFEBE9', icon: '🛋️' },
  automotive: { label: '자동차용품', primary: '#546E7A', secondary: '#ECEFF1', icon: '🚗' },
  stationery: { label: '문구/오피스', primary: '#795548', secondary: '#EFEBE9', icon: '✏️' },
  beverages: { label: '주류/음료', primary: '#AD1457', secondary: '#FCE4EC', icon: '🍷' },
  digital: { label: '디지털/SW', primary: '#0277BD', secondary: '#E1F5FE', icon: '💻' },
  others: { label: '기타', primary: '#757575', secondary: '#FAFAFA', icon: '📦' },
} as const;
